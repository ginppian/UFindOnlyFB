...
class ProductoViewController: UIViewController, UIWebViewDelegate {
...
//                                    self.objNego.promociones = resData["promociones"] as! [[String:AnyObject]]
                                    ...
                                    self.webView.loadHTMLString(self.objNego.productoServicio, baseURL: nil)
                                    print("\(self.objNego.productoServicio)")
